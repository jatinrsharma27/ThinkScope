  ...
  return (
    <nav className={`sticky top-0 z-50 px-6 py-4 transition-all duration-300 ${isScrolled
      ...
      <div className="flex items-center justify-between">
        <a href="/" className="text-2xl font-bold text-black hover:text-gray-800 transition-colors cursor-pointer">
          ThinkScope
        </a>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`md:hidden w-8 h-8 rounded-full cursor-pointer flex items-center justify-center transition-all duration-300 ${isScrolled
                ? 'bg-gray-100/80 backdrop-blur-md border border-gray-200/50 hover:bg-gray-200/80'
          ...
          {isLoggedIn ? (
            ...
            <div className="relative">
              ...
              {showProfileMenu && (
                ...
                <div className="py-1">
                  <div className="px-4 py-2 text-sm text-black border-b border-gray-200">
                    <div className="font-medium">{userProfile?.full_name || 'User'}</div>
                    <div className="text-xs text-gray-500 break-words">{user?.email}</div>
                  </div>

                  <a href="/saved" className="block px-4 py-2 text-sm text-black hover:bg-gray-100">Saved</a>
